...
class FastWooOrderLookup {
  ...
  public static function woocommerce_order_data_store( $store ) {
    if ( 'WC_Order_Data_Store_CPT' === $store ) {
  ...
  private function __construct() {
    add_filter( 'woocommerce_shop_order_search_fields', array( $this, 'woocommerce_shop_order_search_fields' ), 10, 1 );
    add_filter( 'woocommerce_shop_order_search_results', array(
      $this,
   ...
   * @return array
   */
  public function woocommerce_shop_order_search_results( $order_ids, $term, $search_fields ) {
...
// Plugin version
const FAST_WOO_ORDER_LOOKUP_VERSION = '0.1.1';
